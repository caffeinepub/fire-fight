...
export class Backend implements backendInterface {
    ...
    async createGameRoom(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createGameRoom();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async joinGameRoom(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.joinGameRoom(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setPosition(arg0: Position): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setPosition(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
